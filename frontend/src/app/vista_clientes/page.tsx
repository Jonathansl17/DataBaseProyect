...
const OtraPagina = () => {
    ...
    const desconectar = async () => {
        ...
        try {
            await fetch("http://localhost:3100/connection/disconnect", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <p className="text-lg mb-4">Si ven la ruta arriba es http://localhost:3000/vista_clientes por el app router que ofrece next.js.</p>
